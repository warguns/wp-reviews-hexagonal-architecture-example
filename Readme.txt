...
Manage your post reviews with that plugin, rich snippeds are included (json-ld). It's also a plugin as a example to demonstrate hexagonal capabilities inside a wordpress plugin.
